                ...
                okButton.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (producto == null) {
                            ...
                            if (exito) {
                                boolean relacionGuardada = TiendaComputos.getInstance().insertarProveedorProducto(
                                        nuevoProd.getNumSerie(),
                                        proveedor.getId()
                                );
                            ...
                            if (producto instanceof Microprocesador) {
                                ...
                                ((Microprocesador) producto).setVelocidadProcesamiento(
                                        new Integer(spnMPVelocidadProcesamiento.getValue().toString()));
                            }
                            ...
                            pro.add(producto);
                            FacturaCompra fact = new FacturaCompra("Factura - " + Tienda.getNumFactura(), hoy, pro,
                                    proveedor, cantidadfact,
                                    ((preciofact * cantidadfact) - ((preciofact * cantidadfact) * 0.25)));
